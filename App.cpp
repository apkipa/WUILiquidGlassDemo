...
using namespace WUILiquidGlassDemo;
using namespace WUILiquidGlassDemo::implementation;
...
void App::OnLaunched(LaunchActivatedEventArgs const& e)
{
    ...
    if (rootFrame == nullptr)
    {
        ...
        if (e.PrelaunchActivated() == false)
        {
            if (rootFrame.Content() == nullptr)
            {
                ...
                // parameter
                rootFrame.Navigate(xaml_typename<WUILiquidGlassDemo::MainPage>(), box_value(e.Arguments()));
            }
    ...
    Frame frame;
    frame.Navigate(xaml_typename<WUILiquidGlassDemo::MainPage>());
